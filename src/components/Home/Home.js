...
const Home = () => {
    ...
    <header className = { classes.home }>
        ...
        <div className="btn-group mt-2 mb-4" role="group" aria-label="actionButtons">
	        <a href="/" className="btn d-block btn-outline-light btn-lg btn-border-2">View my Work <i id="arrow-icon" className={classes.fas +" fa fa-arrow-right"} aria-hidden="true"></i></a>
        </div>
    </header>
    );
}
